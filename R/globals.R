...
utils::globalVariables(c(
  ".base", ".bnrind", ".chg", ".diff", ".eligible", ".expect", ".factor",
  ".key", ".lb_bl", ".lb_hi", ".lb_ind", ".lb_lo", ".n", ".orres_n", ".pchg",
  ".rank", ".rave_n", ".ref_trtsdt", ".vs_bl", "ABLFL", "ADT", "ADY",
  ...
  "DSTERM", "DTHDT", "DTHDTC", "DTHDTF", "DTHFL", "ENRLSTDT", "EOSDT",
  "EOSDTF", "EOSSTT", "EPOCH", "ETHNIC", "EXADMBY", "EXDOSE", "EXDOSU",
  "EXENDAT_DD", "EXENDAT_MM", "EXENDAT_YYYY", "EXENDTC", "EXENDY", "EXOCCUR",
