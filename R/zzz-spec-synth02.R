...
spec_synth02 <- new_study_spec(
  ...
  bds = tribble(
    ...
    # is declared in spec$totals; MOS05 joins the scoring set.
    "ADQS", "MOS01", 1,  NA,   NA,
    "ADQS", "MOS02", 2,  NA,   NA,
    "ADQS", "MOS03", 3,  NA,   NA,
    "ADQS", "MOS04", 4,  NA,   NA,
  ...
  # The MOOD SCALE total: five items in this protocol, so the declared
  # range is wider than SYNTH01's.
  totals = tribble(
    ~domain, ~paramcd, ~param,             ~paramn, ~anrlo, ~anrhi, ~src_items,
    "ADQS",  "MOSTOT", "MOOD SCALE Total", 6,       4,      15,     "MOS01;MOS02;MOS03;MOS04;MOS05"
  ),
